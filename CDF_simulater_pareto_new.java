    ...
    public static void main(String[] args) throws IOException{
        ...
        //while((txtFileName = br.readLine()) != null) {
     	...
     	//String[] filename = txtFileName.split("¥¥.");
        	...
        	while(market_order_intervals_sum <= 54000 && limit_order_intervals_sum <= 54000 && limit_cancel_intervals_sum <= 54000){
        		if(market_order_intervals_sum == 0 && limit_order_intervals_sum == 0 && limit_cancel_intervals_sum == 0){
            		market_order_intervals_sum = 32400 + cdf.pareto3(ransu.NextUnif(), 0.77, 0.60);
            	 ...
            	 double min_intervals = market_order_intervals_sum;//min_intervalsは時間間隔の累積で一番小さいものを選ぶ変数．この最小値が次に到着する注文となる．
            	  ...
            	  if(next_market_order == true){//次の注文が約定の場合．
            		  ...
            		  market_order_intervals_sum += cdf.pareto3(ransu.NextUnif(), 0.77, 0.60);//次の成行注文の到着時間
            		  ...
            		  if(0.5 < bid_prob){//買い注文
            			  ...
            			  pw.println("Naoki," + String.format("%08d", output_number) + "," + hour_out + ":" + minute_out + ":" + second_out + ",Trade," + ",," + ask_price + "," + bid_market_order + ",,,,,m");       			  
            			  ...
            			  pw.println("Naoki," + String.format("%08d", output_number) + "," + hour_out + ":" + minute_out + ":" + second_out + ",Trade," + ",," + bid_price + "," + ask_market_order + ",,,,,m");
            	  ...
            	  if(next_limit_order == true){//指値注文の到着
            		...
            		//-------------（時刻を出力するための行）----------------
            		  ...
            		  if(0.5 < bid_prob){//買い指値注文
            			  ...
            			  pw.println("Naoki," + String.format("%08d", output_number) + "," + hour_out + ":" + minute_out + ":" + second_out + ",Quote," + ",,,," + bid_price + "," + bid_depth + "," + ask_price + "," + ask_depth +",l");
            	  ...
            	  if(next_limit_cancel == true){//指値キャンセルの到着
            		...
            		//-------------（時刻を出力するための行）----------------
            		  ...
            		  if(0.5 < bid_prob){
            			  ...
            			  pw.println("Naoki," + String.format("%08d", output_number) + "," + hour_out + ":" + minute_out + ":" + second_out + ",Quote," + ",,,," + bid_price + "," + bid_depth + "," + ask_price + "," + ask_depth + ",c");
