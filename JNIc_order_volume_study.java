		...
		while((txtFileName = br.readLine()) != null) {
			...
			while ((line = brtxt.readLine()) != null) {
				...
				if(JNIc_split[4].equals("bid") || (JNIc_split[4].equals("bid") && JNIc_split.length == 6 && !(JNIc_split[5].equals("final trade")))){
					...
					else if(Integer.parseInt(day) < 20110214 && time_total >= 45000 && Integer.parseInt(JNIc_split[2]) > 0){//昼休みがあるときの後場。買い注文
					...
					else if(Integer.parseInt(day) < 20110214 && time_total >= 45000 && Integer.parseInt(JNIc_split[2]) < 0){//昼休みがあるときの後場。買い指値注文のキャンセル
						bid_cancel_sum_afternoon += (-1*Integer.parseInt(JNIc_split[2]));
						bid_cancel_number_afternoon_subtotal++;
					}
					else if(Integer.parseInt(day) >= 20110214 && Integer.parseInt(JNIc_split[2]) > 0){//昼休みが廃止後。買い注文
						bid_arrival_freq += Integer.parseInt(JNIc_split[2]);
						//bid_volume_sum += Integer.parseInt(JNIc_split[2]);
						bid_trade_number_subtotal++;
					}
					else if(Integer.parseInt(day) >= 20110214 && Integer.parseInt(JNIc_split[2]) < 0){//昼休みが廃止後。買い指値注文のキャンセル
						bid_cancel_sum += (-1*Integer.parseInt(JNIc_split[2]));
						bid_cancel_number++;
					}
					else{
						System.out.println(line +" bid");
					}
					...
					else if(Integer.parseInt(day) < 20110214 && time_total >= 45000 && Integer.parseInt(JNIc_split[2]) > 0){//昼休みがあるときの後場。売り注文
					...
					else if(Integer.parseInt(day) < 20110214 && time_total >= 45000 && Integer.parseInt(JNIc_split[2]) < 0){//昼休みがあるときの後場。売り指値注文のキャンセル
					...
					else if(Integer.parseInt(day) >= 20110214  && Integer.parseInt(JNIc_split[2]) < 0){//昼休みが廃止後。売り指値注文のキャンセル
						ask_cancel_sum += (-1*Integer.parseInt(JNIc_split[2]));
						ask_cancel_number++;
					}
					else{
						System.out.println(line + " ask");
					}
