...
public class JNIc_limit_order{
	...
	public static void main(String[] args) throws IOException{
		...
		while((txtFileName = br.readLine()) != null) {
			...
			String move_cause = null;//板が移動する要因（約定以外の移動で使用）
			...
			while ((line = brtxt.readLine()) != null) {
				...
				if(!(Index.substring(0,1).equals("#"))){
					...
					if(transaction.equals("Trade")){
						...
						/*if(ita_change != 0){//pw_depth(成行注文のキャンセルを考慮　ここから)
					...
					if((bid1[0] != ask1[0] && ask1[0] != 0 && bid1[0] != 0 && count13 == 0 && transaction.equals("Quote") && zaraba == true) ||
						...
						if(bid_ask_initialization == 1 && bid1[1] != 0 && ask1[1] != 0){//板が移動した直後の板の厚さ(価格差の制約をつけると厳しくなる模様）
							if(bid_price_same == 0 && ask_price_same == 0 && ask1[1] - bid1[1] == 10){//板が追随して下落（価格差10円）
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",down," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",market");
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",down price dif not 10," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",market");
							...
							/*else if(bid_price_same == 1 && ask_price_same == 0){//売板のみ下落（排除！！！）
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",down only bid," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",market");
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",down price same," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",market");
								//pw_limit.println(day + "," + time + "," + (bid_volume1 + (-1*bid_volume2)) + "," + bid_price_before + ",bid,down price same,,,,");//ok
								//System.out.println(line);
							}
							else{//その他
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",move," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",market");
							}
						}
						else if(bid_ask_initialization == 2 && bid1[1] != 0 && ask1[1] != 0){//板が移動した直後の板の厚さ
							if(bid_price_same == 0 && ask_price_same == 0 && ask1[1] - bid1[1] == 10){
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",up," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",market");
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",up price dif not 10," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",market");

							}
							else if(bid_price_same == 1 && ask_price_same == 0){//売板だけ上昇
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",up only ask," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",market");
							...
							/*else if(bid_price_same == 0 && ask_price_same == 1){（排除！！！）
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",up price same," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",market");
								//pw_limit.println(day + "," + time + "," + (ask_volume1 + (-1*ask_volume2)) + "," + ask_price_before + ",ask,up price same,,,,");//ok
							}
							else{
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",move," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + depth_change_before_bid + "," + depth_change_before_ask + ",other");
							}
						}
							...
							if(bid_price_before == bid1[1] && ask_price_before < ask1[1] && bid_price_same == 1 && ask_price_same == 0){//売板のみの上昇
								if(trade_price1 != ask_price_before || count_trade_before != 0){
									...
									move_cause = "cancel after market";
								}
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",up only ask not Trade," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + bid_volume2 + "," + ask_volume2 + "," + move_cause);
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",down only ask not Trade," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + ",0," + bid_volume2 + "," + ask_volume2 + ",limit");
							}
							else if(bid_price_before < bid1[1] && ask_price_before == ask1[1] && bid_price_same == 0 && ask_price_same == 1){//買板のみの上昇
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",up only bid not Trade," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + ",0," + bid_volume2 + "," + ask_volume2 + ",limit");
							}
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",down only bid not Trade," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + bid_volume2 + "," + ask_volume2 + "," + move_cause);
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",up not Trade," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + bid_volume2 + "," + ask_volume2 + "," + move_cause);
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",up not Trade not 10," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + bid_volume2 + "," + ask_volume2 + "," + move_cause);
							}
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",down not Trade," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + bid_volume2 + "," + ask_volume2 + "," + move_cause);
								...
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",down not Trade not 10," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + bid_volume2 + "," + ask_volume2 + "," + move_cause);

							}
							else{
								pw_depth.println(JNIc_split[2]+ "," + JNIc_split[3] + ",move," + bid1[1] + "," + bid_volume1 + "," + ask1[1] + "," + ask_volume1 + "," + trade_volume1 + "," + bid_volume2 + "," + ask_volume2 + ",other");
							}
						}
