...
//注文を発生させるプログラム
public class CDF_simulater_pareto_new2{
                		...
                		//---------成行注文のパレート分布３----------
                		  ...
                		  if(ask_prob < market_ask_trade_prob [first_number][second_number]){//売り注文
                    		  ...
                    		  if(filename_constant_market.equals("constant.csv")){//定数
                    			  ...
                    			  for_nega = (int)cdf.negabio(ransu.NextUnif(),Double.parseDouble(para_split_simu[0].substring(1)),Double.parseDouble(para_split_simu[1].substring(0,para_split_simu[1].length()-1)));//同一時刻の注文個数

                    			  para_split_simu = ask_market_volume_para[first_number][second_number].split("	", 0);
                    			  ask_market_order = 0;
                    			  for(int i=1;i<=for_nega;i++){
                    				  ask_market_order = ask_market_order + (int)cdf.zeta(ransu.NextUnif(), Double.parseDouble(para_split_simu[0].substring(1)));
                    			  }
                    			  //System.out.println(ask_market_order);
                    			  ...
                    			  ask_market_order = 0;
                    			  for(int i=1;i<=for_nega;i++){
                    				  ask_market_order = ask_market_order + (int)cdf.negabio(ransu.NextUnif(),Double.parseDouble(para_split_simu[0].substring(1)),Double.parseDouble(para_split_simu[1].substring(0,para_split_simu[1].length()-1)));
                    			  }
                			  ...
                			  if(filename_constant_market.equals("constant.csv")){//定数
                    			  ...
                    			  bid_market_order = 0;
                    			  for(int i=1;i<=for_nega;i++){
                    				  bid_market_order = bid_market_order + (int)cdf.zeta(ransu.NextUnif(), Double.parseDouble(para_split_simu[0].substring(1)));
                    			  }
                    			  ...
                    			  bid_market_order = 0;
                    			  for(int i=1;i<=for_nega;i++){
                    				  bid_market_order = bid_market_order + (int)cdf.negabio(ransu.NextUnif(),Double.parseDouble(para_split_simu[0].substring(1)),Double.parseDouble(para_split_simu[1].substring(0,para_split_simu[1].length()-1)));
                    			  }
